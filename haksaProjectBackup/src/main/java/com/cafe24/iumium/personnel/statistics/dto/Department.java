...
public class Department {
	...
	private String yearList;	// 검색 날짜
	private String departmentList;	// 검색학과
	...
	public String toString() {
		return "Department [yearList=" + yearList + ", departmentList=" + departmentList + ", deptCode="
				+ deptCode + ", deptNameKorean=" + deptNameKorean + ", teamCode=" + teamCode + ", teamNameKorean="
				+ teamNameKorean + ", jobRankCode=" + jobRankCode + ", jobRankNameKorean=" + jobRankNameKorean
				+ ", humanName=" + humanName + ", humanPhoneNumber=" + humanPhoneNumber + ", humanEmail=" + humanEmail
				+ ", jobGroupCode=" + jobGroupCode + ", jobGroupName=" + jobGroupName + "]";
	}
