				...
				<table border="">
			        ...
			        <tbody>
	            		<c:forEach var="row" items="${vacationList }">
							...
							<c:choose>
								<c:when test="${row.vacationApprovalStatus eq 'C' }" >
									<td>확인중</td>
								</c:when>
								
								<c:when test="${row.vacationApprovalStatus eq 'Y' }" >
									<td>승인완료</td>
								</c:when>
								
								<c:when test="${row.vacationApprovalStatus eq 'N' }" >
									<td>승인불가</td>
								</c:when>
							</c:choose>
							<td>${row.vacationRegistrationDay }</td>
						</c:forEach>
	        		</tbody>
	    		</table>
